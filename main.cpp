...
int main(){
    ...
    objs.push_back(new sphere(vec3(-4, -1, -30), 4, vec3(0, 0, 0), vec3(0, 0, 1.0), 1.8, vec3(0.97, 0.97, 0.97))); //big glass
    objs.push_back(new sphere(vec3(13, -2, -47.5), 1.5, vec3(0, 0, 0), vec3(0, 0, 1.0), 1.8, vec3(0.97, 0.97, 0.97))); //small glass
